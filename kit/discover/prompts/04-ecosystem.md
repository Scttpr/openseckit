...
| Output | Template URL |
|--------|--------------|
| `integrations.yaml` | `https://raw.githubusercontent.com/Scttpr/openseckit/main/kit/discover/templates/data/integrations.yaml.j2` |
| `supply_chain.yaml` | `https://raw.githubusercontent.com/Scttpr/openseckit/main/kit/discover/templates/data/supply_chain.yaml.j2` |
