...
The discovery process is organized into 7 phases, each with its own specialist prompt:
...
| 6 | `06-synthesis.md` | gaps.yaml, index.yaml | All audiences |
| 7 | `07-documentation.md` | docs/*.md | All audiences |
...
| Type | Path |
|------|------|
| Data templates (YAML) | `.osk/kit/discover/templates/data/*.yaml.j2` |
| Output templates (MD) | `.osk/kit/discover/templates/outputs/*.md.j2` |
...
- **Templates**: Fetch from `https://raw.githubusercontent.com/Scttpr/openseckit/main/kit/discover/templates/outputs/*.md.j2`
