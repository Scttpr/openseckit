...
for f in security-spec security-plan security-tests risks; do
    curl -sf "$GITHUB_RAW/kit/secure/templates/outputs/${f}.md.j2" -o "$DIR/templates/outputs/${f}.md.j2"
done
curl -sf "$GITHUB_RAW/kit/secure/templates/data/risks.yaml.j2" -o "$DIR/templates/data/risks.yaml.j2"
echo "  ✓ templates"
