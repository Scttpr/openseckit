...
1. **Read templates first** from `.osk/kit/comply/frameworks/rgpd/templates/`:
   - Core: `registre-traitement.md.tera`, `mesures-securite.md.tera`, `aipd.md.tera`, `lia.md.tera`, `tia.md.tera`
   - Contracts: `clause-sous-traitant.md.tera`
   - Procedures: `violation-donnees.md.tera`, `droits-personnes.md.tera`
   - Public: `politique-confidentialite.md.tera`
