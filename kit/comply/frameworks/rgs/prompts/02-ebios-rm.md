...
1. **Read templates first** from `.osk/kit/comply/frameworks/rgs/templates/`:
   - `workshop-1-cadrage.yaml.j2`
   - `workshop-2-sources.yaml.j2`
   - `workshop-3-strategic.yaml.j2`
   - `workshop-4-operational.yaml.j2`
   - `workshop-5-treatment.yaml.j2`
   - `risk-register.yaml.j2`
